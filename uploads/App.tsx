...
/* ─────────────────────────────────────────
   AVATAR IMAGE URL
   ▸ Replace the string below with your
     permanent direct image link.
───────────────────────────────────────── */
const AVATAR_IMAGE_URL = "https://github.com/ahmede2test.png";
      ...
      <main className="card" role="main" aria-label="Ahmed Osman ELsisi Business Card">
        ...
        <div className="card-inner">
          ...
          <div className="avatar-section">
            ...
            <div className="avatar-wrapper" aria-label="Profile avatar of Ahmed Osman ELsisi">
              <div className="avatar-outer-ring"></div>
              <div className="avatar-white-ring"></div>

              {/* ── Dynamic Online Image Avatar ── */}
              <div className="avatar-placeholder" aria-hidden="true">
                <img
                  src={AVATAR_IMAGE_URL}
                  alt="Ahmed Osman ELsisi"
                  style={{
                    width: '100%',
                    height: '100%',
                    objectFit: 'cover',
            ...
            <div className="name-block">
              <h1 className="card-name">Ahmed Osman <em>ELsisi</em></h1>
              <div className="card-title-badge">
                <span className="badge-bullet"></span>
                IT Specialist
              </div>
              <p className="card-subtitle">
                IT Technical Support &middot; Orascom Construction (Contrack&nbsp;FM) &middot;
                Flutter Expert &middot; Mobile App Developer
              </p>
            </div>
          ...
          <p className="bio-text">
            Architecting and developing smart, high-performance mobile applications
            with premium, user-centric UI/UX design layouts. Explore my professional
            networks and connect with me directly.
          </p>
          ...
          <div className="skills-section">
            ...
            <div className="skills-row">
              <SkillPill label="Flutter" />
              <SkillPill label="App Developer" />
              <SkillPill label="MySQL" />
              <SkillPill label="API Integration" />
              <SkillPill label="IT Support" />
            </div>
          </div>
          ...
          <div className="icon-row" role="list" aria-label="Social and contact links">
            <SquircleLink href="https://www.linkedin.com/in/ahmed-osman22" label="LinkedIn" title="LinkedIn">
              <LinkedInIcon />
            </SquircleLink>
            <SquircleLink href="https://github.com/ahmede2test" label="GitHub" title="GitHub">
              <GitHubIcon />
            </SquircleLink>
            <SquircleLink href="https://ahmed-osman-portfolio.vercel.app/" label="Portfolio Website" title="Portfolio">
              <PortfolioIcon />
            </SquircleLink>
            <SquircleLink href="https://www.facebook.com/share/18tkT6hhhc/" label="Facebook" title="Facebook">
              <FacebookIcon />
            </SquircleLink>
            <SquircleLink href="https://www.instagram.com/eng_ahmed_el_sisiy?igsh=dW1pbHU1M2E0cG50" label="Instagram" title="Instagram">
              <InstagramIcon />
            </SquircleLink>
            <SquircleLink href="mailto:ahmed.osmanis.fcai@gmail.com" label="Send Email" title="Email" external={false}>
              <EmailIcon />
            </SquircleLink>
          </div>
          ...
          <div className="cta-row">
            <CtaButton href="tel:+201027451231" label="Call Ahmed Osman ELsisi" variant="call">
              <PhoneIcon />
              <span>Call Now</span>
            </CtaButton>
            <CtaButton href="https://wa.me/201027451231" label="WhatsApp Chat with Ahmed Osman ELsisi" variant="wa" external>
              <WhatsAppIcon />
              <span>WhatsApp</span>
            </CtaButton>
          </div>
        ...
        {/* ── CARD BASELINE FOOTER ── */}
        <div className="card-footer">
          <span className="card-footer-baseline">Ahmed Osman &nbsp;&bull;&nbsp; 2026 &nbsp;&bull;&nbsp; Digital Card</span>
        </div>
